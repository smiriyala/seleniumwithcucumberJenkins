...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Selenium 4
        System.setProperty("webdriver.chrome.driver", "C:\\libs");
    ...
    private static void Selenium4MiscFetures(ChromeDriver chromeDriver){
        ...
        newTab.get("http://localhost:8080/login");

        //login
        newTab.findElement(By.name("j_username")).sendKeys("admin");
        newTab.findElement(By.name("j_password")).sendKeys("admin");
        newTab.findElement(By.name("Submit")).submit();
        ...
        WebElement elements = (WebElement) lstElements
                .stream()
                .map(x -> x.getAttribute("input"));

        //should be 7
        System.out.println(((Stream<WebElement>) elements).count());
    }
}
